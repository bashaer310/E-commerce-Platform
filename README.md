...
This is a backend solution for an e-commerce platform, built with C#, ASP.NET, and PostgreSQL. The platform allows artists to showcase their works, while customers can purchase artworks and book art workshops. It includes core features like **user authentication**, **product management (artworks, workshops)**, **category management (types of artwork)**, **order and booking processing**.
...
- **Product Management (artworks, workshops)**:
  - **Product Management** - artists can create, update, and delete products (title, description, price)
  - **Product Browsing** - customers can retrieve products with pagination and filtering
  - **Product Details** - customers can view product details
...
- **Order Management**:
  ...
  - **Order History** - customers can view order history with pagination and filtering
...
- **Booking Management**:
  ...
  - **Booking History** - customers can view booking history with pagination and filtering
